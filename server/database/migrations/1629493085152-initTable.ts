...
export class initTable1629493085152 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "map_marker" ("id" SERIAL NOT NULL, "lat" double precision NOT NULL, "long" double precision NOT NULL, "s2_path" character varying NOT NULL, "name" character varying NOT NULL, "shortDescription" character varying, "description" character varying, "documents" character varying, "informants" character varying, "houseNumber" character varying, "road" character varying, "city" character varying, "state" character varying, "postcode" character varying, "site" character varying, "email" character varying, "phone" character varying, "logo" character varying, "images" text, "audio" character varying, "video" character varying, "created" TIMESTAMP DEFAULT now(), "updated" TIMESTAMP DEFAULT now(), "mapId" integer, CONSTRAINT "PK_c60cf8d2d96efa4b2a114ca1412" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
